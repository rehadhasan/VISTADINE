                                ...
                                <div key={index} className="relative group">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-md transition-opacity">
                                        <div className="flex items-center text-white space-x-4">
                                            <a target='_blank' href={`https://www.linkedin.com/in/${member.linkedin}`} className="text-2xl">
                                                <FaLinkedinIn size={24} className='hover:text-primary'/>
                                            </a>
                                            <a target='_blank' href={`https://www.facebook.com/${member.facebook}`} className="text-2xl">
                                                <FaFacebookF size={24} className='hover:text-primary'/>
                                            </a>
                                            <a target='_blank' href={`https://www.twitter.com/${member.twitter}`} className="text-2xl">
                                                <FaXTwitter size={24} className='hover:text-primary'/>
                                            </a>
                                            <a target='_blank' href={`https://www.instagram.com/${member.instagram}`} className="text-2xl">
